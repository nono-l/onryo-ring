  ...
  return (
    <main className="terms-page">
      ...
      <section>
        ...
        <p>
          設定の<strong>マニュアル</strong>では、ユニットを掴んでいる間だけ円陣が止まる。アクティブが今までの仕様。
        </p>
      </section>
      ...
      <section>
        <h2>上級ユニット</h2>
        <p>
          花魁のHPが15%以下、または処理数が38に達したとき、1ラン1回だけ道が開く。店の「道が近い」でこの待ちも早まる。成功するとその式神が円陣に降り、以降の手毬召喚の候補にも入る。失敗すると寿司が6皿増え、花魁はゴール側へ進む。
        </p>
        <ul className="how-list">
          <li>
      ...
      <section>
        ...
        <p>
          二の強化の消費が 1 万両以上、かつ3種とも Lv.2 以上になると<strong>三の強化</strong>が開く。口寄せの種は最初から手毬1つで追加召喚。押し戻しは寿司撃破のバック量。輪刃は振り回す武器が円に等間隔で増える。
        </p>
      </section>
